...
**And the job converges on exactly the capability that is eroding.** The best current explanation for why software engineers have not been displaced is that requirements, verification, and accountability resist automation: someone must own the outcome, organisationally (Narayanan & Kapoor, 2026). The empirical trace is striking — in the first year of New York's WARN Act disclosure rule, more than 160 companies filed layoff notices and not one ticked the AI-displacement box. Shipper (2026) makes the same point from the demand side: more automation raises the need for human judgment, not less, because the cognitive overhead of directing machines scales with what they can do. Put those together and the scissor closes. Employment is consolidating around sign-off. Sign-off runs on judgment. Judgment is the capability this document shows quietly draining, unmeasured, while every dashboard reports the throughput going up.
...
- Anthropic (2026). Agentic Coding and Persistent Returns to Expertise (~400,000 Claude Code sessions, ~235,000 users, Oct 2025–Apr 2026).
...
- Narayanan, A., & Kapoor, S. (2026). Why AI Hasn't Replaced Software Engineers. Via Willison, S., simonwillison.net (June 2026). NY WARN Act data: 160+ filings, zero AI-displacement disclosures.
- Shipper, D. (2026). The AI Paradox. Lenny's Podcast (May 2026).
